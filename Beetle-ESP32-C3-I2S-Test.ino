// Adapted by Scuba Hacker - Mark Jones - For Mercator Origins Silky Audio Module development
// Requires a modified DFRobot_MAX98357A library, as it has a bug that causes a core dump on Beetle ESP32-C3
// See github/scuba-hacker repo: DFRobot-MAX98357A-ESP32-C3-Scuba-Hacker-Lib
/*!
 * @file  SDmusic.ino
...
void setup(void)
{
   ...
   */
  while ( !amplifier.initI2S(/*_bclk=*/I2S_AMP_BCLK_PIN, /*_lrclk=*/I2S_AMP_LRCLK_PIN, /*_din=*/I2S_AMP_DIN_PIN) ){
